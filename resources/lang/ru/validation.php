...
return [
    ...
    */
    ...
    'max'                  => [
        'numeric' => 'Это поле должно быть не больше :max.',
        'file'    => 'Это поле должно быть не больше :max Килобайт.',
        'string'  => 'Это поле должно быть не длиннее :max символов.',
    ...
    'min'                  => [
        'numeric' => 'Это поле должно быть не менее :min.',
        'file'    => 'Это поле должно быть не менее :min Килобайт.',
        'string'  => 'Это поле должно быть не короче :min символов.',
    ...
    'required_unless'      => 'Это поле обязательно для заполнения',
    'required_with'        => 'Это поле обязательно для заполнения, когда :values указано.',
    'required_with_all'    => 'Это поле обязательно для заполнения, когда :values указаны.',
    'required_without'     => 'Это поле обязательно для заполнения, когда :values не указано.',
    'required_without_all' => 'Это поле обязательно для заполнения, когда :values не указаны.',
